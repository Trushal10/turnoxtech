      ...
      <div className="overflow-hidden">
        <div className="container lg:pt-20 pt-10 relative">
          <div className="relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 my-0 pt-10 items-center">
              <div className="lg:col-span-7 mb-16">
                <h1 className="mb-5 lg:text-start text-center sm:leading-snug leading-tight capitalize">
                  Empowering Digital Growth <br /> with Trunox Tech
                </h1>
                <p className="text-white font-normal mb-10 max-w-[70%] lg:text-start text-center lg:mx-0 mx-auto capitalize">
                  Trunox Tech is a leading IT solutions company delivering web, app, and software 
                  development services that drive innovation, scalability, and digital transformation 
                ...
                <div className="flex align-middle justify-center lg:justify-start">
                  ...
                  >
                    <Image
                      ...
                      height={47}
                    />
                    <span className="hover:text-primary">Watch Overview</span>
                  </button>
                </div>
              </div>
              <div className="lg:col-span-5 lg:-m-48 -m-20 overflow-hidden lg:w-[800px]">
                <Image
                  src={"https://creativemarketingltd.com/wp-content/uploads/elementor/thumbs/Footer-hero-qeds1qoygjfjnxleuh7blzyjculso0qqxypspsy8lc.png"}
                  alt="nothing"
                  width={1013}
                  height={760}
                />
